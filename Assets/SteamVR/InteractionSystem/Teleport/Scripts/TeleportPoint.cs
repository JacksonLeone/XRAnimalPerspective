...
namespace Valve.VR.InteractionSystem
{
	...
	public class TeleportPoint : TeleportMarkerBase
	{
		...
		public override void UpdateVisuals()
		{
			...
			if ( locked )
			{
				SetMeshMaterials( pointLockedMaterial, titleLockedColor );
		...
		public void UpdateVisualsInEditor()
		{
			...
			if ( locked )
			{
				...
				markerMesh.sharedMaterial = pointLockedMaterial;
				lockedIcon.sharedMaterial = pointLockedMaterial;
			...
			else
			{
				...
				switchSceneIcon.sharedMaterial = pointVisibleMaterial;
